...
\begin{algorithm}
	...
	%\SetKwFunction{algo}{algo}\SetKwFunction{mulint}{operator *}
	\SetKwFunction{algo}{algo}\SetKwFunction{mul}{operator * }
	\SetKwFunction{algo}{algo}\SetKwFunction{div}{operator / }
	\SetKwFunction{algo}{algo}\SetKwFunction{div}{operator < }
	\SetKwFunction{algo}{algo}\SetKwFunction{div}{simplify}
  ...
  \nl B = q.b*p.c - p.b*q.c\;
  \nl \If{sign(A)*A*A $<$ sign(B)*B*B}{
  \nl \KwRet true\;}
	\nl \KwRet false\;}
  
  \setcounter{AlgoLine}{0}
	\SetKwProg{myproc}{Function}{}{}
	\myproc{\div{\textnormal{p}}}{
  \nl cache = 0\;
